    ...
    if(req.body.id){
        ...
        if (history_json && history_json.owner === req.user.id){
            let mailOptions = {
                ...
                html: `Olá, o usuário ${req.user.username} está solicitando a publicação da história "${history_json.Titulo}", cujo id é ${req.body.id}, acesse em <a href='http://${req.get('Host')}${req.originalUrl}/admin/editar_historia/${req.body.id}/'>confirmar</a>   .
                `
            };
